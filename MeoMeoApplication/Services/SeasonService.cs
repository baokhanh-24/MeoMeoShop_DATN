...
namespace MeoMeo.Application.Services
{
    public class SeasonService : ISeasonService
    {
        ...
        public async Task<CreateOrUpdateSeasonResponse> CreateSeasonAsync(SeasonDTO dto)
        {
            ...
            await _seasonRepository.CreateSeasonAsync(newseason);
        ...
        public async Task<CreateOrUpdateSeasonResponse> UpdateSeasonAsync(SeasonDTO dto)
        {
            CreateOrUpdateSeasonResponse response = new CreateOrUpdateSeasonResponse();
            var getId = await _seasonRepository.GetSeasonByIDAsync(dto.Id);
            if(getId == null)
            {
